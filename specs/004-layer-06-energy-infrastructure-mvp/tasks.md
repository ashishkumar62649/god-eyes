...
- [ ] Create migration directory `database/migrations/layers/layer_06_energy_infrastructure/`
...
- [ ] Create test directory `tests/data/layer_06_energy_infrastructure/`
...
- [ ] Create fetcher directory `services/fetch-orchestrator/src/layers/layer_06_energy_infrastructure/`
...
- [ ] Create normalizer directory `services/normalizer/src/layers/layer_06_energy_infrastructure/`
...
- [ ] Update `docs/control/layer_06_energy_infrastructure_mvp_contract.md`
